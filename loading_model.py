...
class NnModel(object):
    ...
    def two_stream_vgg_load(self):
       ...
       # self.dropout_layer(self.d_pool3)
        ...
        # self.conv2d_tanh(self.s_pool3, 19, 'conv4_1', stream_name='s')
        # self.conv2d_tanh(self.s_conv4_1, 21, 'conv4_2', stream_name='s')
        ...
        # self.conv2d_tanh(self.s_pool4, 28, 'conv5_1', stream_name='s')
        # self.conv2d_tanh(self.s_conv5_1, 30, 'conv5_2', stream_name='s')
